...
module.exports = {
  ...
  execute(message,args,client) {
    ...
    .setTitle("De lijst met HofRegels!")
    .addField('Actuele informatie', `Prefix: \`${PREFIX}\`\nJe kan mijn aandacht krijgen door ${client.user} te typen.`, false)
    .addField("• Belangerijke mensen", `\`\`\`yml\nName: OJ Punctuel \nMaker Ξ Thijmen#4933 \`\`\``)
    .addField("• Belangerijke linkjes!", `**[Tis ongeheurd!](https://www.youtube.com/watch?v=Ka-zUDmThFI)\`|\`[happy birthday efteling](https://www.youtube.com/watch?v=fiudB081NSw)\`|\`[Youtube](https://www.youtube.com/channel/UCoulm-mYV-JzzRgu4o6rGVw)\`**`)
    .addField(`Alle roepingen`)
      .setFooter( client.user.username +` Typ: ${PREFIX}help <Command> Voor meer info!`)
      .setColor("#F0EAD6");
