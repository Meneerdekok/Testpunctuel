    ...
    collector.on("collect", async (reaction, user) => {
      ...
      switch (reaction.emoji.name) {
        case "⏭":
          ...
          queue.textChannel.send(`${user} ⏩ Heeft het nummer overgeslagen.`).catch(console.error);
          collector.stop();
          break;
        ...
        case "⏯":
          ...
          if (queue.playing) {
            ...
            queue.textChannel.send(`${user} ⏸ Heeft de muziek gepauzeerd.`).catch(console.error);
          } else {
            queue.playing = !queue.playing;
        ...
        case "🔇":
          ...
          if (queue.volume <= 0) {
            ...
            queue.textChannel.send(`${user} 🔊 Heeft de muziek geunmute`).catch(console.error);
          } else {
            queue.volume = 0;
            queue.connection.dispatcher.setVolumeLogarithmic(0);
            queue.textChannel.send(`${user} 🔇 heeft de muziek gemute!`).catch(console.error);
          }
          break;
        ...
        case "🔉":
          ...
          queue.textChannel
            .send(`${user} 🔉 Heeft het volume verlaagd, Het volume is nu. ${queue.volume}%`)
            .catch(console.error);
          break;
